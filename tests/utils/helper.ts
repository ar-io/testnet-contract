...
import { DEFAULT_ANT_CONTRACT_ID, DEFAULT_INITIAL_STATE, DEFAULT_WALLET_FUND_AMOUNT } from "./constants";
...
export async function createLocalWallet(arweave: Arweave): Promise<{wallet: JWKInterface, address: string}> {
...
export async function setupInitialContractState(owner: string, wallets: string[]): Promise<IOState> {
