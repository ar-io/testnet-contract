...
export const MIN_NETWORK_JOIN_STAKE = 50_000; // The amount of tokens needed to stake to join a gateway to the network
export const MIN_DELEGATED_STAKE = MIN_NETWORK_JOIN_STAKE * 0.01; // The minimum amount of tokens needed to delegate to another gateway on the network
export const MAX_RESERVED_DELEGATES = 10_000; // The maximum number of delegated stakers for a single gateway.
...
export const MINIMUM_GATEWAY_JOIN_LENGTH = DEFAULT_EPOCH_BLOCK_LENGTH * 4;
export const GATEWAY_LEAVE_LENGTH = DEFAULT_EPOCH_BLOCK_LENGTH * 8; // 8 epochs
export const DELEGATED_STAKE_UNLOCK_LENGTH = DEFAULT_EPOCH_BLOCK_LENGTH * 2; // two epochs
