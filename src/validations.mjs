...
const schema12 = {
  ...
  properties: {
    ...
    details: {
      ...
      type: 'object',
      properties: {
        contractTxId: { type: 'string', pattern: '^[a-zA-Z0-9-]{43}$' },
        years: { type: 'integer', minimum: 1 },
        tier: { type: 'string', pattern: '^[a-zA-Z0-9-]{43}$' },
      },
                      ...
                      if (
                        ...
                        if (_errs10 === errors) {
                          ...
                          if (valid1) {
                            ...
                            if (valid1) {
                              if (data3.tier !== undefined) {
                                let data6 = data3.tier;
                                  ...
                                  if (typeof data6 === 'string') {
                                    if (!pattern2.test(data6)) {
                                      validate11.errors = [
                                        {
                                          instancePath:
                                            instancePath + '/details/tier',
                                          schemaPath:
                                            '#/properties/details/properties/tier/pattern',
                                          keyword: 'pattern',
                                          params: {
                                    ...
                                    validate11.errors = [
                                      {
                                        instancePath:
                                          instancePath + '/details/tier',
                                        schemaPath:
                                          '#/properties/details/properties/tier/type',
                                        keyword: 'type',
                                        params: { type: 'string' },
                                        message: 'must be string',
                                      },
