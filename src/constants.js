...
exports.AUCTION_SETTINGS = exports.AUCTION_SETTINGS_ID = exports.FEE_STRUCTURE = exports.TIERS = exports.CURRENT_TIERS = exports.INVALID_SHORT_NAME = exports.INVALID_YEARS_MESSAGE = exports.INVALID_ID_TIER_MESSAGE = exports.INVALID_TIER_MESSAGE = exports.INVALID_QTY_MESSAGE = exports.INVALID_TARGET_MESSAGE = exports.INSUFFICIENT_FUNDS_MESSAGE = exports.EXISTING_ANT_SOURCE_CODE_TX_MESSAGE = exports.ARNS_NAME_DOES_NOT_EXIST_MESSAGE = exports.NON_EXPIRED_ARNS_NAME_MESSAGE = exports.INVALID_INPUT_MESSAGE = exports.ARNS_NAME_RESERVED_MESSAGE = exports.INVALID_ARNS_NAME_MESSAGE = exports.NON_CONTRACT_OWNER_MESSAGE = exports.UNDERNAME_REGISTRATION_IO_FEE = exports.ANNUAL_PERCENTAGE_FEE = exports.ALLOWED_ACTIVE_TIERS = exports.UNDERNAMES_COUNT = exports.MINIMUM_ALLOWED_NAME_LENGTH = exports.MINIMUM_ALLOWED_EVOLUTION_DELAY = exports.MAX_ALLOWED_EVOLUTION_DELAY = exports.SHORT_NAME_RESERVATION_UNLOCK_TIMESTAMP = exports.NETWORK_HIDDEN_STATUS = exports.NETWORK_LEAVING_STATUS = exports.NETWORK_JOIN_STATUS = exports.FOUNDATION_DELAYED_EVOLVE_COMPLETED_STATUS = exports.FOUNDATION_ACTION_PASSED_STATUS = exports.FOUNDATION_ACTION_FAILED_STATUS = exports.FOUNDATION_ACTION_ACTIVE_STATUS = exports.RESERVED_ATOMIC_TX_ID = exports.SECONDS_IN_GRACE_PERIOD = exports.SECONDS_IN_A_YEAR = exports.TX_ID_LENGTH = exports.MAX_FOUNDATION_ACTION_PERIOD = exports.MAX_PORT_NUMBER = exports.MAX_GATEWAY_LABEL_LENGTH = exports.MAX_NOTE_LENGTH = exports.MAX_NAME_LENGTH = exports.MAX_YEARS = exports.MAX_DELEGATES = void 0;
...
exports.NON_EXPIRED_ARNS_NAME_MESSAGE = 'This name already exists in an active lease';
exports.ARNS_NAME_DOES_NOT_EXIST_MESSAGE = 'Name does not exist in the ArNS Contract!';
exports.EXISTING_ANT_SOURCE_CODE_TX_MESSAGE = 'This ANT Source Code Transaction ID is already allowed.';
...
exports.INVALID_QTY_MESSAGE = 'Invalid quantity. Must be an integer and greater than 0.';
exports.INVALID_TIER_MESSAGE = 'Invalid tier.';
exports.INVALID_ID_TIER_MESSAGE = 'Invalid tier ID. Must be present in state before it can be used as a current tier.';
exports.INVALID_YEARS_MESSAGE = "Invalid number of years. Must be an integer and less than or equal to ".concat(exports.MAX_YEARS);
exports.INVALID_SHORT_NAME = "Name is less than ".concat(exports.MINIMUM_ALLOWED_NAME_LENGTH, " characters. It will be available for auction after ").concat(exports.SHORT_NAME_RESERVATION_UNLOCK_TIMESTAMP, ".");
